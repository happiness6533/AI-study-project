...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open("../../environment/grid_world/img/up.png").resize((13, 13)))
        right = PhotoImage(Image.open("../../environment/grid_world/img/right.png").resize((13, 13)))
        left = PhotoImage(Image.open("../../environment/grid_world/img/left.png").resize((13, 13)))
        down = PhotoImage(Image.open("../../environment/grid_world/img/down.png").resize((13, 13)))
        rectangle = PhotoImage(Image.open("../../environment/grid_world/img/rectangle.png").resize((65, 65)))
        triangle = PhotoImage(Image.open("../../environment/grid_world/img/triangle.png").resize((65, 65)))
        circle = PhotoImage(Image.open("../../environment/grid_world/img/circle.png").resize((65, 65)))
