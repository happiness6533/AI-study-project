...
class Env(tk.Tk):
    ...
    def load_images(self):
        rectangle = PhotoImage(
            Image.open("../../environment/grid_world/img/rectangle.png").resize((30, 30)))
        triangle = PhotoImage(
            Image.open("../../environment/grid_world/img/triangle.png").resize((30, 30)))
        circle = PhotoImage(
            Image.open("../../environment/grid_world/img/circle.png").resize((30, 30)))
